                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="paramedical">
                            <ul class="nav flex-column">
                                <li class="nav-item"><a class="nav-link" href="paraklinik_mah_m.php"><i class="fa fa-calendar me-2"></i> آمار پذيرش پاراكلينيك ها</a></li>
                                <li class="nav-item"><a class="nav-link" href="bastari_m.php"><i class="fa fa-bed me-2"></i> آمار پذيرش بيماران بستري</a></li>
                                <li class="nav-item"><a class="nav-link" href="serve_paraklinik_m.php"><i class="fa fa-medkit me-2"></i> تعداد سرويس هاي پاراكلينيك</a></li>
                                <li class="nav-item"><a class="nav-link" href="amal_mah_m.php"><i class="fa fa-list me-2"></i> تعداد هر عمل در ماه</a></li>
                            </ul>
                        </div>
                    </li>
                    <!-- سایر منوها -->
